        ...
        <section className="detail-section">
            <div className="detail-container container">
                ...
                <div className="detail-activities">
                    ...
                    {activities.length > 0 && activities.map((activity, index) => <ActivityCard history={history} key={index} index={index} activity={activity} _loadActivities={_loadActivities} />)}
